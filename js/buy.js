...
function myConfirm() {
    ...
    CalcRef.update ({
        ...
        TotalPrice: Number(document.getElementById('buy_num_in_farm1').value) * 2000 + Number(document.getElementById('buy_num_in_farm2').value) * 1800 + Number(document.getElementById('buy_num_in_farm3').value) * 2100
    });
